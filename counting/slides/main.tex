...
\begin{frame}{ตัวอย่าง: รังนกพิราบ}
  ...
  \begin{solbox}[วิธีทำ]
    \textbf{กรณีแย่ที่สุด:} หยิบได้สีไม่ซํ้าเลย $\rightarrow$ หยิบ 3 ครั้ง ได้ แดง, นํ้าเงิน, ดำ
    หยิบครั้งที่ 4: จะซํ้ากับสีใดสีหนึ่งแน่นอน

    \medskip
    ดังนั้นต้องหยิบอย่างน้อย \highlight{4 ครั้ง} จึงมั่นใจว่าได้สีซํ้า
  \end{solbox}
\end{frame}
...
\begin{frame}{ตัวอย่าง: ข้อสอบจริง}
  ...
  \begin{solbox}[วิธีทำ]
    จับคู่ที่ผลรวมเป็น 8: $(1,7), (2,6), (3,5)$ — มี 3 คู่ และ $4$ ที่ไม่มีคู่เพราะห้ามใช้เลขซํ้า (= 4 รัง)

    \medskip
    กรณีแย่ที่สุด: เลือกมา 3 ตัวจากคนละคู่ และเลือก $4$ $\rightarrow$ ยังไม่มีคู่ไหนรวมเป็น 8 \newline
    ตัวที่ 5: ต้องซํ้ากับคู่ใดคู่หนึ่ง $\rightarrow$ ผลรวมเป็น 8
