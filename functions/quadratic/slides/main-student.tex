...
\title[ฟังก์ชันกำลังสอง]{\textcolor{white}{ฟังก์ชันกำลังสอง} \textcolor{boxBlue!60}{(Quadratic Functions)}}
\subtitle{กราฟพาราโบลา • จุดยอด • ราก • การจัดรูป }
...
\begin{frame}{ก่อนเรียน (Prerequisites)}
  ...
  \begin{intuition}[ฟังก์ชันกำลังสองคืออะไร?]
    ฟังก์ชันที่มี $x^2$ เป็นพจน์ดีกรีสูงสุด — กราฟเป็นเส้นโค้งรูปตัว U หงายหรือควํ่า
    ...
    \column{0.5\textwidth}
      \begin{explanation}[รูปร่างของกราฟ]
        \begin{itemize}
          ...
          \item $a < 0$: พาราโบลา \highlight{ควํ่า} $\cap$
          \item $|a|$ มาก: กราฟแคบ
...
% ===========================================================================
%  SECTION 3: จุดยอด แกนสมมาตร และค่าสูงสุด/ตํ่าสุด
% ===========================================================================
\section{จุดยอด แกนสมมาตร และค่าสูงสุด/ตํ่าสุด}
...
\begin{frame}{การหาจุดยอดและแกนสมมาตร}
  \begin{explanation}[สูตร]
    ...
    \begin{itemize}
      ...
      \item \textbf{ค่าสูงสุด/ตํ่าสุด}: $k = f(h)$
      \begin{itemize}
        \item $a > 0$: \highlight{ค่าตํ่าสุด} $= k$ (หงาย)
        \item $a < 0$: \highlight{ค่าสูงสุด} $= k$ (ควํ่า)
      \end{itemize}
    \end{itemize}
  \end{explanation}
  ...
  \begin{exambox}
    ...
    จุดยอด $= (2, -3)$, แกนสมมาตร $x = 2$, \highlight{ค่าตํ่าสุด $= -3$}
  \end{exambox}
\end{frame}
...
\begin{frame}[t]{ตัวอย่าง: สร้างสมการจากราก}
...
% ===========================================================================
%  SECTION 6: การหาค่าสูงสุด/ตํ่าสุดประยุกต์
% ===========================================================================
\section{โจทย์ประยุกต์}

\begin{frame}[t]{โจทย์ปัญหาค่าสูงสุด/ตํ่าสุด}
  \begin{exambox}[โจทย์]
...
\begin{frame}[t]{โจทย์ปัญหา: พื้นที่มากที่สุด}
  \begin{exambox}[โจทย์]
...
\begin{frame}[t]{โจทย์ปัญหา: กำไรสูงสุด}
  \begin{exambox}[โจทย์]
...
\begin{frame}{โจทย์ปัญหา: เงื่อนไขราก}
  ...
  \begin{intuition}[สรุป]
    สัมผัสแกน $x$ $\iff$ $\Delta = 0$ $\iff$ มีหนึ่งราก (รากซํ้า) $\iff$ จุดยอดอยู่บนแกน $x$
  \end{intuition}
\end{frame}
    ...
    \begin{columns}[T]
      \column{0.5\textwidth}
        \begin{itemize}
          ...
          \item \textbf{ค่าสูงสุด/ตํ่าสุด}: $a>0$ ตํ่าสุด, $a<0$ สูงสุด
        \end{itemize}
      \column{0.5\textwidth}
        \begin{itemize}
