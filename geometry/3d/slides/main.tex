...
\title[รูปสามมิติ]{รูปสามมิติ}
\subtitle{3D Shapes — ปริซึม, พีระมิด, ทรงกระบอก, กรวย, ทรงกลม, ปริมาตร, พื้นที่ผิว}
...
\begin{frame}{ตัวอย่าง: เปรียบเทียบและประยุกต์}
  ...
  \begin{exambox}[โจทย์ 2]
    ถังน้ำทรงกระบอกมีเส้นผ่านศูนย์กลาง 1.4 ม. สูง 2 ม. จุน้ำได้กี่ลิตร?
  \end{exambox}
