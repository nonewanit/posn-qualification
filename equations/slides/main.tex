...
% --- Document info ---
\title[สมการ]{\textcolor{white}{สมการและอสมการ} \textcolor{boxBlue!60}{(Equations \& Inequalities)}}
\subtitle{สมการเชิงเส้น • สมการกำลังสอง • ระบบสมการ • อสมการ • Sign Chart • ค่าสัมบูรณ์ }
  ...
  \begin{explanation}
    ...
    \begin{center}
      \begin{tabular}{c|c|c}
        ...
        $\Delta = 0$ & 1 คำตอบ (ซํ้า) & กราฟสัมผัสแกน $x$ \\
...
\begin{frame}{ตัวอย่าง: อสมการค่าสัมบูรณ์}
  \begin{columns}[T]
    \column{0.4\textwidth}
      ...
      \end{exambox}
    \column{0.6\textwidth}
      \begin{exambox}[โจทย์ 2: $|2x - 1| \geq 3$]
        \begin{align*}
