...
% --- Document info ---
\title[ตรรกศาสตร์]{\textcolor{white}{ตรรกศาสตร์} \textcolor{boxBlue!60}{(Logic)}}
\subtitle{ประพจน์ • ตัวเชื่อม • ตารางค่าความจริง • ตัวบ่งปริมาณ • การอ้างเหตุผล }
...
\begin{frame}{ระวัง! การอ้างเหตุผลที่ผิด}
  \begin{exambox}[ตัวอย่างการอ้างเหตุผลที่ \textbf{ไม่} สมเหตุสมผล]
    ...
    \medskip
    (ถนนอาจเปียกเพราะรถนํ้าผ่าน ไม่จำเป็นต้องฝนตก)
