...
\problem{
  จงเขียน $0.333\ldots$ ในรูปเศษส่วนอย่างตํ่า
}{
  ให้ $x = 0.333\ldots$,
  $10x = 3.333\ldots$,
  $9x = 3$,
...
\problem{
  จงคำนวณค่าต่อไปนี้และตอบในรูปเศษส่วนอย่างตํ่า
  \begin{enumerate}
...
\problem{
  จงเขียนอัตราส่วนต่อไปนี้ในรูปอย่างตํ่า
  \begin{enumerate}
    \item[(ก)] $12 : 18$
    \item[(ข)] $0.5 : 2$
  \end{enumerate}
...
\problem{
  จงเขียน $0.\overline{27}$ (ทศนิยมซํ้า 27) ในรูปเศษส่วนอย่างตํ่า
}{
