...
% --- Document info ---
\title[จำนวนจริง]{จำนวนจริง}
\subtitle{Real Numbers — ระบบจำนวน, เศษส่วน, ทศนิยม, สัดส่วน, สมบัติ, ค่าสัมบูรณ์, เลขยกกำลัง}
...
\begin{frame}{จำนวนตรรกยะ vs อตรรกยะ}
  \begin{explanation}[จำนวนตรรกยะ (Rational)]
    ...
    \begin{itemize}
      ...
      \item ทศนิยมซ้ำ: $0.\overline{3} = \frac{1}{3}$, $0.\overline{142857} = \frac{1}{7}$
    \end{itemize}
  \end{explanation}
...
\begin{frame}{กรณีพิเศษ: ทศนิยมซ้ำ $0.\overline{1}$}
  ...
  \begin{intuition}[เทคนิคการแปลงทศนิยมซ้ำ]
    \begin{itemize}
      \item ถ้าซ้ำ 1 หลัก $\rightarrow$ คูณด้วย $10^1 = 10$ แล้วลบ
      \item ถ้าซ้ำ 2 หลัก $\rightarrow$ คูณด้วย $10^2 = 100$ แล้วลบ
      \item ถ้าซ้ำ $n$ หลัก $\rightarrow$ คูณด้วย $10^{\,n}$ แล้วลบ
    \end{itemize}
  \end{intuition}
\end{frame}
...
\begin{frame}{การทำให้เศษส่วนเป็นอย่างต่ำ}
...
\begin{frame}{อัตราส่วน (Ratio)}
  ...
  \begin{exambox}[ตัวอย่าง]
    \begin{itemize}
      ...
      \item น้ำเชื่อมใช้น้ำตาล 2 ส่วน น้ำ 5 ส่วน
      \par อัตราส่วน น้ำตาล : น้ำ = $2 : 5$
...
\begin{frame}{สรุปเนื้อหา}
  \begin{explanation}[สิ่งที่ได้เรียนรู้]
    \begin{enumerate}
      ...
      \item \textbf{เศษส่วน}: การบวก ลบ คูณ หาร และการทำให้เป็นอย่างต่ำ
