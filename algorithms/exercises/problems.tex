...
\problem{
  ...
  \begin{pseudocode}
    \textbf{1.)} รับค่า $N$ \\
    \textbf{2.)} ให้ $i = 1$ \\
    \textbf{3.)} ทำซ้ำเมื่อ $i \leq N$ \\
    .\qquad \textbf{3.1)} ให้ $j = i$ \\
    .\qquad \textbf{3.2)} ทำซ้ำเมื่อ $j \leq N$ \\
