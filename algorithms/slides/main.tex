...
% --- Pseudo code box (matches main box style — green theme) ---
...
\title[ขั้นตอนวิธี]{\textcolor{white}{ขั้นตอนวิธี} \textcolor{boxBlue!60}{(Algorithms)}}
\subtitle{การติดตาม Pseudo Code • กลยุทธ์การทำโจทย์ 7 ประเภท • โจทย์ Fill-in }
...
\begin{frame}{Pseudo Code ในข้อสอบ สอวน.}
  \begin{explanation}[รูปแบบ]
    \begin{itemize}
      ...
      \item การเยื้อง (indent) แสดงการอยู่ภายใต้เงื่อนไขหรือการวนซํ้า
    \end{itemize}
  \end{explanation}
...
\begin{frame}{การแปลง Python $\leftrightarrow$ Pseudo Code}
  \begin{explanation}
    \begin{tabular}{l|l}
      ...
      \texttt{else}: & มิฉะนั้น \\
      \texttt{while} เงื่อนไข: & ทำซํ้าเมื่อ เงื่อนไข \\
      \texttt{x = 5} & ให้ $x$ มีค่าเท่ากับ $5$ \\
      \texttt{print(x)} & พิมพ์ $x$ / แสดงผล $x$ \\
      \texttt{break} & ออกจากการวนซํ้า \\
...
\begin{frame}{ตัวอย่าง: การวนซํ้าซับซ้อน}
  \begin{exambox}
